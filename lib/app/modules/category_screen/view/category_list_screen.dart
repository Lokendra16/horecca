...
class CategoryListScreen extends StatelessWidget {
  ...
  final CategoryListScreenController controller =
      Get.put(CategoryListScreenController());
                ...
                child: InkWell(
                  onTap: () {
                    Get.to(TableTopScreen(
                        homeList: homeScreenController.homeList));
                  },
                  child: Card(
                    elevation: 3,
                        ...
                        child: Row(
                          children: [
                            ...
                            Assets.icons.icArrowForward
                                .svgIcon(color: ColorName.black, size: 18),
                          ],
                        ),
                      ),
                    ),
