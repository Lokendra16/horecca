                            ...
                            itemBuilder: (BuildContext context, int index) {
                              ...
                              return Column(
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () {
                                      controller.changeAddressIndex(index);
                                    },
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Obx(
                                              () => Row(children: [
                                                controller.isDefaultAddressIndex.value == index
                                                    ? const Icon(
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Row(
                                                      children: [
                                                        Text(
                                                          'Mobile:',
                                                          style: AppThemeData.font14Weight600Gray,
                                                        ),
                                                        Text(
                                                          item.phone.toString(),
                                                  ...
                                                  Obx(
                                                    () => Container(
                                                      ...
                                                      width: 119,
                                                      decoration: BoxDecoration(
                                                          color: controller.isDefaultAddressIndex ==
                                                                  index
                                                              ? ColorName.panache
                                                              : ColorName.mercury,
                                                          borderRadius: BorderRadius.circular(6)),
                                                      child: Center(
                                                        child: Text(
                                                          "Delivering here",
                                                          style: controller.isDefaultAddressIndex ==
                                                                  index
                                                              ? AppThemeData.font14Weight600Jewel
                                                              : AppThemeData.font14Weight600Jewel
